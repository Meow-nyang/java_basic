...
//        t1.run();t2.run();t3.run();t4.run();
 ...
 /*       Sonata[] sonatas = {s1, s2, s3};
        ...
        // 다형성을 적용해서 서로 다른 타입 객테를 모아놓을 수 있다. (이종 모음의 배열)
        ...
        // 객체가 2개 생서되는 게 아니라, 하나의 객체를 두 개의 방식으로 접근하는 겁니다.
        System.out.println(myTesla);
        System.out.println(t5);  // 둘 주소는 같다 객체는 하나

        // Object 타입의 변수는 어떤 객체든 담을 수는 있지마느 객체 고유의 기능을 사용하려면
